...
class BlackScholesPricingForm(BaseView):
    ...
    def CreateBSView(self, option_list, main_text='Black-Scholes Calculation'):
        ...
        self.CreateEntry(control_frame,name='K',text='StockPrice',row=1,column=0,textvar=tk.DoubleVar())
        self.CreateEntry(control_frame,name='t',text='StockPrice',row=1,column=0,textvar=tk.DoubleVar())
        self.CreateEntry(control_frame,name='r',text='StockPrice',row=1,column=0,textvar=tk.DoubleVar())
        self.CreateEntry(control_frame,name='q',text='StockPrice',row=1,column=0,textvar=tk.DoubleVar())
        self.CreateEntry(control_frame,name='vol',text='StockPrice',row=1,column=0,textvar=tk.DoubleVar())
